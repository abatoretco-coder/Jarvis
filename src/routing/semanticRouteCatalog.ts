...
export const CALENDAR_E1_ROUTES: SemanticRouteDefinition[] = [
  ...
  {
    key: 'calendar.delete_event',
    level: 'E1',
    targetAgentId: 'calendar',
    directRequest: { domain: 'calendar', action: 'delete_event' },
    plannerRequired: true,
    examples: [
      'supprime mon rendez-vous dentiste demain',
      'annule l evenement garage',
      'efface la reunion de vendredi dans mon agenda',
    ],
    metadata: { category: 'productivity', latencyTarget: 140 },
  },
  {
    key: 'calendar.update_event',
    level: 'E1',
    targetAgentId: 'calendar',
    directRequest: { domain: 'calendar', action: 'update_event' },
    plannerRequired: true,
    examples: [
      'deplace la reunion a 16h',
      'change le lieu de l evenement',
      'modifie mon rdv garage demain matin',
    ],
    metadata: { category: 'productivity', latencyTarget: 140 },
  },
  {
    key: 'calendar.remove_from_event',
    level: 'E1',
    targetAgentId: 'calendar',
    directRequest: { domain: 'calendar', action: 'remove_from_event' },
    plannerRequired: true,
    examples: [
      'supprime la description de l evenement garage',
      'retire le rappel de la reunion',
      'retire un invite de l evenement',
    ],
    metadata: { category: 'productivity', latencyTarget: 140 },
  },
  {
